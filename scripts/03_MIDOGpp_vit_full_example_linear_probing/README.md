### Full Example: ViT-S Feature Extraction and Linear Probing on MIDOGpp
...
##### 1. **Feature Extraction**
    ...
    - Reads image paths and labels from MIDOGpp dataset
    - Loads images from MIDOGpp
    - Extracts features for the full MIDOGpp dataset
...
##### 2. **Linear Probing**
    ...
    - Trains linear classifiers at multiple relative training set sizes:
        ...
        - 0.1 (10% of the data)
        - 1 (100% of the data)
    - Uses multiple random seeds for monte carlo cross validation
